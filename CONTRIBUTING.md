...
## Our Expectations
- Contributions must respect the project's guidelines and scope.
...
2. Make changes in a branch. Recommended branch naming depends a lot on the repository, but a recommended naming scheme is: `<version>/<name>/feat-<desc>`, where "version" is the version currently in development, "name" is your GitHub username and "desc" is a short description.
3. Submit a pull request with a clear description of your changes. We recommend you follow the default PR template.
4. Be civil and respectful when being given and giving feedback.
